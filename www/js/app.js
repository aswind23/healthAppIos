var userModule = angular.module('userModule', ['ionic', 'ngRoute', 'ngStorage']);
...
"use strict";
var pageModule = angular.module('pageModule', ['ngRoute','ionic', 'ngMap', 'ui.bootstrap', 'ngNumberPicker', 'ngStorage', 'ngAnimate']);
...
pageModule.run(function($ionicPlatform) {
...
var app = {
    ...
    onDeviceReady: function() {
        ...
        var successHandler = function (pedometerData) {
            $scope.munsteps = pedometerData.numberOfSteps;
            $scope.wholeData = pedometerData;
        }
